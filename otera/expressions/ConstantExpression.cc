...
void otera::ConstantExpression::Execute(const otera::Environment &env, std::ostream &output_stream) {
    output_stream << this->text;
}

std::string otera::ConstantExpression::GetCommandName() {
